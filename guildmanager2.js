...
, arrayAllMemberGuild = [],DetailError;
...
// 									+"'UNION ALL SELECT timeLogin FROM `users` WHERE `UserName` = '"+currentSENDREQUESTENTERTOGUILD.UserName+"'",function(error, rows,field)
// 								{
// 									if (!!error)
// 									{	
...
// 															  			{												  																	                		
// 													                		socket.broadcast.to(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayALLLeader[i].MemberName)].idSocket).emit('R_JOIN_GUILD_TO_LEADER',
// 																			{
...
// 									            			+"' OR PositionGuild = 'Leader' OR PositionGuild='CoLeader') AND GuildName = '"+currentSENDREQUESTENTERTOGUILDBYUSER.GuildName+"'",function(error, rows,field)
// 														{
...
// 								  											{									  												
// 															  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayResponseInviteByGuild[i].MemberName)].idSocket).emit('R_ACCEPT_INVITE_WITH_GUILD_MEMBER',
// 																				{																			
// 																					GuildName:currentSENDREQUESTENTERTOGUILDBYUSER.GuildName,																	
// 															                	});
// 														                	}else
// 														                	{															                		
// 														                		io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayResponseInviteByGuild[i].MemberName)].idSocket).emit('R_ACCEPT_INVITE_WITH_GUILD_LEADER',
// 																				{
...
// 										var query = pool.query("SELECT * FROM `guildlistmember` WHERE (ActiveStatus=2 OR ActiveStatus=1) AND GuildName = '"+currentSENDACCEPTINVITEWITHGUILD.GuildName+"'",function(error, rows,field)
// 								        {
...
// 													//dữ liệu policy
// 													var query = pool.query("SELECT * FROM `policys` where GuildName='"+currentSENDACCEPTINVITEWITHGUILD.GuildName+"'",function(error, rows,field)
// 											        {
...
// 																	  				{										  																  					
// 																	  					socket.emit(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayResponseInviteByGuild[i].MemberName)].idSocket).emit('R_ACCEPT_INVITE_WITH_GUILD_NEW_MEMBER',
// 																						{																				
...
// 																	  				}else
// 																	  				{
// 																	  					socket.broadcast.to(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayResponseInviteByGuild[i].MemberName)].idSocket).emit('R_ACCEPT_INVITE_WITH_GUILD_ALL_MEMBER',
// 																						{
...
// 									  			{
// 								  					socket.broadcast.to(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayLeader[i].MemberName)].idSocket).emit('R_REJECT_INVITE_WITH_GUILD_BY_MEMBER',
// 													{
...
// 									  			{	
// 									  				io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === currentSENDREJECTINVITEWITHGUILDBYLEADER.UserName)].idSocket).emit('R_REJECT_INVITE_WITH_GUILD_BY_LEADER',
// 													{
...
// 													  			{	
// 													  				io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayLeader[k].MemberName)].idSocket).emit('R_REJECT_INVITE_WITH_GUILD_BY_LEADER',
// 																	{
// 																		ExpireInviteToJoinGuild:arrayResetJoin[0],
// 												                	});							                														  									  								                	
// 													  			}	
...
// 					{
// 						if (result.affectedRows>0) 
// 						{	var query = pool.query("SELECT * FROM `guildlistmember` WHERE (ActiveStatus=2 OR ActiveStatus=1) AND GuildName = '"+currentSENDACCEPTJOINGUILDBYLEADER.GuildName+"'",function(error, rows,field)
// 					        {
...
// 										arrayAllMemberGuild = rows;
// 										//dữ liệu policy
// 										var query = pool.query("SELECT * FROM `policys` where GuildName='"+currentSENDACCEPTJOINGUILDBYLEADER.GuildName+"'",function(error, rows,field)
// 								        {
...
// 														  				{															  													  					
// 														  					socket.broadcast.to(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayResponseAcceptJoinGuildByLeader[i].MemberName)].idSocket).emit('R_ACCEPT_JOIN_GUILD_BY_LEADER_NEW_MEMBER',
// 																			{
...
// 														  				}else
// 														  				{
// 														  					socket.emit(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayResponseAcceptJoinGuildByLeader[i].MemberName)].idSocket).emit('R_ACCEPT_JOIN_GUILD_BY_LEADER_ALL_MEMBER',
// 																			{
...
// 															  				socket.broadcast.to(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayResponseAcceptJoinGuildByLeader[i].MemberName)].idSocket).emit('R_ACCEPT_JOIN_GUILD_BY_LEADER_ALL_MEMBER',
// 																			{
// 																				UserName:(arrayResponseAcceptJoinGuildByLeader[arrayResponseAcceptJoinGuildByLeader.findIndex(item => item.MemberName === currentSENDACCEPTJOINGUILDBYLEADER.UserName)]),																		
// 														                	});
// 														  				}									  															  								                	
...
// 													  			{	
// 												  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arraySendUpMember[i].MemberName)].idSocket).emit('R_UP_MEMBER_IN_GUILD',
// 																	{
...
// 													  			if ((lodash.filter(gameServer.clients, x => x.name === arraySendUpMember[i].MemberName)).length >0) 
// 													  			{	
// 												  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arraySendUpMember[i].MemberName)].idSocket).emit('R_DOWN_MEMBER_IN_GUILD',
// 																	{
// 																		arrayMemberChange:arrayMemberChange,																		
// 												                	});													  													  															  								                	
// 													  			}													  							  			
...
// 									  			{	
// 								  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayPolicyChange[i].MemberName)].idSocket).emit('R_POLICY_CHANGE',
// 													{
...
// 															  			{	
// 														  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayGuildDonate[i].MemberName)].idSocket).emit('R_RESOURCE_DIAMOND_DONATE',
// 																			{
...
// 												  			{	
// 											  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayGuildDonate[i].UserName)].idSocket).emit('R_DATA_UP_GUILD',
// 																{
...
// 											  			{	
// 										  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayGuildNotify[i].MemberName)].idSocket).emit('R_REMOVE_MEMBER_IN_GUILD',
// 															{
...
// 											  			{	
// 										  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayAllUsers[i].MemberName)].idSocket).emit('R_INFOMATION_GUILD',
// 															{
// 																arrayUserRemoved:arrayUserRemoved,																																																																												
// 										                	});											  													  															  								                	
// 											  			}													  							  			
...
// 								}
// 								connection.query("SELECT MemberName FROM `guildlistmember` WHERE GuildName = '"+currentSENDCHANGERESOURCEGUILD.GuildName+"'",function(error, rows,field)
// 								{
...
// 										{
// 											arrayGuildNotify = rows;
// 											connection.query("SELECT Farm, Wood, Stone, Metal, Diamond FROM `guildlist` WHERE GuildName = '"+currentSENDCHANGERESOURCEGUILD.GuildName+"'",function(error, rows,field)
// 											{
...
// 												  			if ((lodash.filter(gameServer.clients, x => x.name === arrayGuildNotify[i].MemberName)).length >0) 
// 												  			{	
// 											  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayGuildNotify[i].MemberName)].idSocket).emit('R_RESOURCE_CHANGE',
// 																{
...
// 													  									{													  										
// 																							io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arraySentResourceOfGuildToUser[index].MemberName)].idSocket).emit('R_RESOURCE_FROM_GUID_MEMBER',
// 																							{
// 																								arrayGuildAfterSendResourceBase:arrayGuildAfterSendResourceBase,																				
// 																		                	});
// 																						}																							

// 																		               	io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arraySentResourceOfGuildToUser[index].MemberName)].idSocket).emit('R_RESOURCE_FROM_GUID_TO_ALL_MEMBER',
// 																						{
...
// 						if (result.affectedRows>0) 
// 						{
// 							var query = pool.query("SELECT * FROM `guildlistmember` WHERE GuildName = '"+currentSENDMEMBEROOUTGUILD.GuildName
...
// 									{
// 										arrayUserRemoved =rows;
// 										var query = pool.query("SELECT * FROM `guildlistmember` WHERE GuildName = '"+currentSENDMEMBEROOUTGUILD.GuildName+"'",function(error, rows,field)
// 										{
...
// 											  			if ((lodash.filter(gameServer.clients, x => x.name === arrayGuildNotify[i].MemberName)).length >0) 
// 											  			{	
// 										  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayGuildNotify[i].MemberName)].idSocket).emit('R_MEMBER_OUT_GUILD',
// 															{
// 																arrayUserRemoved:arrayUserRemoved,																																																																												
// 										                	});													  													  															  								                	
// 											  			}													  							  			
...
// 							  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayResetJoin[index].MemberName)].idSocket).emit('R_RESET_JOIN_GUILD',
// 												{
...
// 															if ((lodash.filter(gameServer.clients, x => x.name === arrayLeader[k].MemberName)).length >0) 
// 												  			{													  				
// 											  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayLeader[k].MemberName)].idSocket).emit('R_RESET_JOIN_GUILD',
// 																{
// 																	ExpireInviteToJoinGuild:arrayResetJoin[index],
// 											                	});							                														  									  								                	
// 												  			}	
...
// 								    var gameServer = new GameServer();
// 								    exports.gameServer = gameServer;
// 									if((result.affectedRows>0) && (gameServer.clients.length>0))
// 									{																																					  			
...
// 											  			{													  				
// 										  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayMember[k].UserName)].idSocket).emit('R_RESET_OUT_GUILD',
// 															{
...
// 							  			{							  					
// 						  					io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayAllGuild[i].LeaderName)].idSocket).emit('R_RESET_RESOURCE_CHANGE_DIAMOND',
// 											{
...
//     }
// }
exports.start = start: function(io) {
	io.on('connection', function(socket) 
	{
        //user gửi request tham gia guild
        socket.on('S_REQUEST_ENTER_TO_GUILD', function (data)
...
{
	var query = pool.query("SELECT Farm, Wood, Stone, Metal FROM `guildlist` WHERE GuildName = '"+GuildName+"'",function(error, rows,field)
	{												
	...
	}else
	{
		if (rows.length>0) 
		{
			...
			var query = pool.query("SELECT * FROM `guildlistmember` WHERE GuildName = '"+GuildName+"'",function(error, rows,field)
			{
			...
			}else
			{
				if (rows.length>0) 
				{
					...
					for (var k = 0; k < arrayAllMemberGuilds.length; k++) 
					{
						...
						{	
							io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayAllMemberGuilds[k].MemberName)].idSocket).emit('R_DONATE_COMPLETE',
							{
...
{
	var query = pool.query("UPDATE guildlist SET "+NameResourceFrom+" = "+NameResourceFrom+" - '"+parseFloat(QualityResourceFrom)
...
{
	var query = pool.query("UPDATE guildlist SET "+NameResourceFrom+" = "+NameResourceFrom+" - '"+parseFloat(Quality)														
		...
		}else
		{
			...
			{																	
				...
				}else
				{
					...
					{
						arrayGuildNotify = rows;
						var query = pool.query("SELECT * FROM `guildlist` WHERE GuildName = '"+GuildName+"'",function(error, rows,field)
						{
						...
						}else
						{
							if (rows.length>0) 
							{
								...
								{								  			
									if ((lodash.filter(gameServer.clients, x => x.name === arrayGuildNotify[i].MemberName)).length >0) 
									{	
										io.in(gameServer.clients[gameServer.clients.findIndex(item => item.name === arrayGuildNotify[i].MemberName)].idSocket).emit('R_RESOURCE_CHANGE_DIAMOND',
										{
											arrayResourceChange:rows[0],																																																																												
										});																					                	 										  													  															  								                	
									}													  							  			
